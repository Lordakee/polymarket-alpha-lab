...
def adapter_module() -> types.ModuleType:
    sys.modules.pop("polymarket_alpha_lab.outcome_tracking_psycopg", None)
    return importlib.import_module("polymarket_alpha_lab.outcome_tracking_psycopg")
...
def test_insert_opens_psycopg_connection_delegates_commits_and_closes(
    ...
    assert store_table_name == "outcome_tracking_archive"
