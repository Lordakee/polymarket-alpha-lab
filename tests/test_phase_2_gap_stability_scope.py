...
def test_phase_2_gap_stability_import_scope_is_pure_phase_2_memory_only():
...
def test_phase_2_gap_stability_has_no_forbidden_names_calls_aliases_or_escapes():
    tree = _tree()
