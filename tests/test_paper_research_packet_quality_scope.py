...
MODULE_NAME = "polymarket_alpha_lab.paper_research_packet_quality"
MODULE_PATH = (
    REPO_ROOT / "src" / "polymarket_alpha_lab" / "paper_research_packet_quality.py"
)
...
def test_paper_research_packet_quality_module_can_be_found_and_imported():
...
def test_paper_research_packet_quality_imports_only_allowed_dependencies():
    tree = parse_module()
...
def test_paper_research_packet_quality_exports_only_public_reducer_api():
    tree = parse_module()

    assert module_exports(tree) == EXPECTED_EXPORTS


def test_paper_research_packet_quality_does_not_mention_forbidden_surfaces():
    tree = parse_module()
    normalized_terms = {
...
def test_paper_research_packet_quality_does_not_perform_io_or_dynamic_execution():
    tree = parse_module()
