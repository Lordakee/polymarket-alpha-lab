...
LEGACY_DURABLE_FILE_PERSISTENCE_ALLOWLIST = frozenset(
    (
        ...
        "src/polymarket_alpha_lab/strategy_cycle.py:327: durable file-backed append method PaperStrategyCycleLog.append",
        "src/polymarket_alpha_lab/strategy_cycle.py:342: durable file append open(a)",
