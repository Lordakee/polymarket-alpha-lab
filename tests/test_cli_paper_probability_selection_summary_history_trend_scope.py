...
HELPER = "_run_paper_probability_selection_summary_history_trend"
SUMMARY = "_print_paper_probability_selection_summary_history_trend_summary"
...
EXPECTED_BRANCH_CALLS = {
    ...
    "_redacted_paper_probability_selection_summary_history_trend_error",
    HELPER,
    SUMMARY,
}
...
def test_history_trend_parser_surface_is_env_db_only_without_persist() -> None:
    tree = parse_cli()
    parser_variable = _command_parser_variable(tree, COMMAND)
...
def test_history_trend_branch_uses_history_env_config_helper_and_summary() -> None:
    tree = parse_cli()
    ...
    assert "paper_probability_selection_summary_history_trend_runner" in references
    assert "paper_probability_selection_summary_history_db_sink" not in references
    _assert_no_forbidden_fragments(references, FORBIDDEN_PHASE_ESCAPE_FRAGMENTS)


def test_history_trend_helper_loads_history_reports_and_builds_report() -> None:
    tree = parse_cli()
...
def test_history_trend_summary_is_aggregate_only() -> None:
    tree = parse_cli()
