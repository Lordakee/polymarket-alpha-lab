...
HELPER = "_run_paper_research_packet_quality_db_history"
SUMMARY = "_print_paper_research_packet_quality_db_history_summary"
HISTORY_CONFIG_VERSION = "paper-research-packet-quality-history-v0"
HISTORY_CONFIG_CONSTANT = (
...
FORBIDDEN_BRANCH_CALLS = {
    ...
    "_run_paper_research_packet_quality",
...
def test_packet_quality_db_history_parser_surface_is_exactly_limit_only() -> None:
    tree = parse_cli()
...
def test_packet_quality_db_history_branch_is_quality_db_read_only() -> None:
    tree = parse_cli()
    ...
    assert "paper_research_packet_quality_db_history_runner" in references
...
def test_packet_quality_db_history_helper_uses_quality_loader_and_readonly_connection() -> None:
    tree = parse_cli()
...
def test_packet_quality_db_history_summary_is_aggregate_only() -> None:
    tree = parse_cli()
