...
MODULE_PATH = (
    ...
    / "phase_2_observability_state.py"
)
...
ALLOWED_PROJECT_IMPORTS = {
    ...
    "polymarket_alpha_lab.phase_2_observability_trends",
...
ALLOWED_STRING_VALUES = {
    ...
    "phase_2_ready must be a bool",
    "phase_2_ready must match blocking_reason_names",
...
def test_observability_state_import_scope_is_local_and_report_only():
    tree = parse_module()
...
def test_observability_state_has_no_forbidden_names_or_aliases():
    tree = parse_module()
...
def test_observability_state_has_no_forbidden_calls_or_attributes():
    tree = parse_module()
...
def test_observability_state_has_no_dynamic_escape_strings():
    tree = parse_module()
