...
HELPER = "_run_probability_selection_scorer_agreement_trend"
SUMMARY = "_print_probability_selection_scorer_agreement_trend_summary"
...
FORBIDDEN_PARSER_ARGUMENT_SURFACE = {
    ...
    "--db-table",
    "db_table",
    "--probability-selection-scorer-agreement-db-dsn",
    "probability_selection_scorer_agreement_db_dsn",
    "--probability-selection-scorer-agreement-db-table",
    "probability_selection_scorer_agreement_db_table",
    "--selection-db-dsn",
    "selection_db_dsn",
    "--selection-db-table",
    "selection_db_table",
...
FORBIDDEN_BRANCH_CALLS = {
    ...
    "_run_probability_selection_scorer_agreement",
    ...
    "_print_probability_selection_scorer_agreement_summary",
...
def test_agreement_trend_parser_surface_is_env_db_only_without_persist_or_writes() -> None:
    tree = parse_cli()
    parser_variable = _command_parser_variable(tree, COMMAND)
...
def test_agreement_trend_branch_uses_agreement_env_config_redacted_error_and_summary() -> None:
    tree = parse_cli()
    ...
    assert "probability_selection_scorer_agreement_trend_runner" in references
    assert "probability_selection_scorer_agreement_runner" not in references
...
def test_agreement_trend_helper_loads_agreement_reports_and_builds_trend_readonly() -> None:
    tree = parse_cli()
    ...
    assert TREND_CONFIG_VERSION in references
...
def test_agreement_trend_failures_are_redacted_without_payload_or_identity_fields() -> None:
    tree = parse_cli()
...
def test_agreement_trend_summary_is_aggregate_only_with_safe_reason_formatting() -> None:
    tree = parse_cli()
