...
explanations, but those reports are not order instructions.
...
-> paper execution/journal later
```

The recommendation layer consumes prior paper reports. It should not fetch live
market data or mutate external state by itself.
