"""Pure report-only energy event specialist memory readiness report."""
...
DEFAULT_RESEARCH_ENERGY_EVENT_TEAM_MEMORY_CONFIG_VERSION = (
    "research-energy-event-team-memory-report-v0"
)
...
NO_OBSERVATIONS_REASON = "energy_event_team_memory_no_observations"
PASS_REASON = "energy_event_team_memory_pass"
WATCH_REASON = "energy_event_team_memory_watch"
BLOCK_REASON = "energy_event_team_memory_block"
...
EVIDENCE_REUSE_BELOW_WATCH_REASON = "evidence_reuse_below_watch"
EVIDENCE_REUSE_BELOW_PASS_REASON = "evidence_reuse_below_pass"
CALIBRATION_SAMPLE_BELOW_WATCH_REASON = "calibration_sample_below_watch"
CALIBRATION_SAMPLE_BELOW_PASS_REASON = "calibration_sample_below_pass"
CALIBRATION_READY_BELOW_WATCH_REASON = "calibration_ready_below_watch"
CALIBRATION_READY_BELOW_PASS_REASON = "calibration_ready_below_pass"
...
REASON_CODE_PRIORITY = (
    ...
    EVIDENCE_REUSE_BELOW_WATCH_REASON,
    CALIBRATION_SAMPLE_BELOW_WATCH_REASON,
    CALIBRATION_READY_BELOW_WATCH_REASON,
    MEMORY_SCORE_BELOW_PASS_REASON,
    SOURCE_FRESHNESS_BELOW_PASS_REASON,
    SOURCE_AGE_ABOVE_PASS_REASON,
    EVIDENCE_REUSE_BELOW_PASS_REASON,
    CALIBRATION_SAMPLE_BELOW_PASS_REASON,
    CALIBRATION_READY_BELOW_PASS_REASON,
)
...
__all__ = (
    "DEFAULT_RESEARCH_ENERGY_EVENT_TEAM_MEMORY_CONFIG_VERSION",
    "STATUSES",
    "ResearchEnergyEventTeamMemoryConfig",
    "ResearchEnergyEventTeamMemoryObservation",
    "ResearchEnergyEventTeamMemoryReasonCodeCount",
    "ResearchEnergyEventTeamMemoryReport",
    "ResearchEnergyEventTeamMemoryRow",
    "build_research_energy_event_team_memory_report",
    "research_energy_event_team_memory_report_digest",
    "research_energy_event_team_memory_report_payload",
)


@dataclass(frozen=True)
class ResearchEnergyEventTeamMemoryConfig:
    config_version: str = DEFAULT_RESEARCH_ENERGY_EVENT_TEAM_MEMORY_CONFIG_VERSION
    ...
    min_pass_evidence_reuse_ratio: Decimal = Decimal("0.700000")
    min_watch_evidence_reuse_ratio: Decimal = Decimal("0.400000")
    min_pass_calibration_sample_count: Decimal = Decimal("30")
    min_watch_calibration_sample_count: Decimal = Decimal("10")
    min_pass_calibration_ready_ratio: Decimal = Decimal("0.700000")
    min_watch_calibration_ready_ratio: Decimal = Decimal("0.450000")
    ...
    def __init_subclass__(cls, **kwargs: object) -> None:
        ...
        if cls is not ResearchEnergyEventTeamMemoryConfig:
            raise TypeError("ResearchEnergyEventTeamMemoryConfig is final")

    def __post_init__(self) -> None:
        if type(self) is not ResearchEnergyEventTeamMemoryConfig:
            raise ValueError(
                "config must be exactly ResearchEnergyEventTeamMemoryConfig",
            )
        object.__setattr__(
            self,
            "config_version",
        ...
        for field_name in (
            ...
            "min_pass_calibration_ready_ratio",
            "min_watch_calibration_ready_ratio",
        ):
            object.__setattr__(
                self,
                field_name,
...
@dataclass(frozen=True)
class ResearchEnergyEventTeamMemoryObservation:
    event_family: str
    specialist_key: str
    ...
    calibration_ready_ratio: Decimal
    paper_only: bool = True
    report_only: bool = True
    readonly: bool = True
    ...
    def __init_subclass__(cls, **kwargs: object) -> None:
        super().__init_subclass__(**kwargs)
        if cls is not ResearchEnergyEventTeamMemoryObservation:
            raise TypeError("ResearchEnergyEventTeamMemoryObservation is final")

    def __post_init__(self) -> None:
        if type(self) is not ResearchEnergyEventTeamMemoryObservation:
            raise ValueError(
                "observation must be exactly ResearchEnergyEventTeamMemoryObservation",
            )
        object.__setattr__(
            self,
            "event_family",
...
@dataclass(frozen=True)
class ResearchEnergyEventTeamMemoryRow:
    event_family: str
    specialist_key: str
    memory_score: Decimal
    source_count: Decimal
    ...
    def __init_subclass__(cls, **kwargs: object) -> None:
        super().__init_subclass__(**kwargs)
        if cls is not ResearchEnergyEventTeamMemoryRow:
            raise TypeError("ResearchEnergyEventTeamMemoryRow is final")

    def __post_init__(self) -> None:
        if type(self) is not ResearchEnergyEventTeamMemoryRow:
            raise ValueError("row must be exactly ResearchEnergyEventTeamMemoryRow")
        object.__setattr__(
            self,
            "event_family",
            _require_public_identifier("event_family", self.event_family),
...
@dataclass(frozen=True)
class ResearchEnergyEventTeamMemoryReasonCodeCount:
    reason_code: str
    count: Decimal
    paper_only: bool = True
    report_only: bool = True
    ...
    def __init_subclass__(cls, **kwargs: object) -> None:
        super().__init_subclass__(**kwargs)
        if cls is not ResearchEnergyEventTeamMemoryReasonCodeCount:
            raise TypeError("ResearchEnergyEventTeamMemoryReasonCodeCount is final")

    def __post_init__(self) -> None:
        if type(self) is not ResearchEnergyEventTeamMemoryReasonCodeCount:
            raise ValueError(
...
@dataclass(frozen=True)
class ResearchEnergyEventTeamMemoryReport:
    ...
    overall_evidence_reuse_ratio: Decimal
    average_calibration_ready_ratio: Decimal
    ...
    status: str
    reason_codes: tuple[str, ...]
    reason_code_counts: tuple[ResearchEnergyEventTeamMemoryReasonCodeCount, ...]
    rows: tuple[ResearchEnergyEventTeamMemoryRow, ...]
    ...
    def __init_subclass__(cls, **kwargs: object) -> None:
        super().__init_subclass__(**kwargs)
        if cls is not ResearchEnergyEventTeamMemoryReport:
            raise TypeError("ResearchEnergyEventTeamMemoryReport is final")

    def __post_init__(self) -> None:
        if type(self) is not ResearchEnergyEventTeamMemoryReport:
            raise ValueError(
                "report must be exactly ResearchEnergyEventTeamMemoryReport",
            )
        ...
        for field_name in (
            ...
            "overall_evidence_reuse_ratio",
            "average_calibration_ready_ratio",
        ):
            object.__setattr__(
                self,
                field_name,
...
def build_research_energy_event_team_memory_report(
    observations: list[ResearchEnergyEventTeamMemoryObservation]
    | tuple[ResearchEnergyEventTeamMemoryObservation, ...],
    *,
    config: ResearchEnergyEventTeamMemoryConfig,
    generated_at: datetime,
) -> ResearchEnergyEventTeamMemoryReport:
    if type(config) is not ResearchEnergyEventTeamMemoryConfig:
        raise ValueError(
            "config must be exactly ResearchEnergyEventTeamMemoryConfig",
        )
    ...
    values: dict[str, object] = {
        ...
        "evidence_reuse_count": _sum_rows(rows, "evidence_reuse_count"),
        "calibration_sample_count": _sum_rows(rows, "calibration_sample_count"),
        ...
        "overall_evidence_reuse_ratio": _ratio(
            _sum_rows(rows, "evidence_reuse_count"),
            _sum_rows(rows, "source_count"),
        ),
        "average_calibration_ready_ratio": _average_row_ratio(
            rows,
            "calibration_ready_ratio",
        ),
        "min_calibration_sample_count": _min_row_decimal(
            rows,
            "calibration_sample_count",
        ),
    ...
    return ResearchEnergyEventTeamMemoryReport(
        **values,
        derived_validation_digest=_digest_from_values(values),
    )


def research_energy_event_team_memory_report_payload(
    report: ResearchEnergyEventTeamMemoryReport,
) -> dict[str, object]:
    if type(report) is not ResearchEnergyEventTeamMemoryReport:
        raise ValueError(
            "report must be exactly ResearchEnergyEventTeamMemoryReport",
        )
...
def research_energy_event_team_memory_report_digest(
    report: ResearchEnergyEventTeamMemoryReport,
) -> str:
    if type(report) is not ResearchEnergyEventTeamMemoryReport:
        raise ValueError(
...
def _build_rows(
    observations: tuple[ResearchEnergyEventTeamMemoryObservation, ...],
    config: ResearchEnergyEventTeamMemoryConfig,
    generated_at: datetime,
) -> tuple[ResearchEnergyEventTeamMemoryRow, ...]:
    rows = tuple(
...
def _row_for_observation(
    observation: ResearchEnergyEventTeamMemoryObservation,
    config: ResearchEnergyEventTeamMemoryConfig,
    generated_at: datetime,
) -> ResearchEnergyEventTeamMemoryRow:
    ...
    evidence_reuse_ratio = _ratio(
        observation.evidence_reuse_count,
        observation.source_count,
    )
    source_age_seconds = (
        ZERO_COUNT
    ...
    return ResearchEnergyEventTeamMemoryRow(
        ...
        calibration_ready_ratio=observation.calibration_ready_ratio,
        status=status,
...
def _row_status(
    *,
    ...
    if (
        ...
        or evidence_reuse_ratio < config.min_watch_evidence_reuse_ratio
        or observation.calibration_sample_count < config.min_watch_calibration_sample_count
        or observation.calibration_ready_ratio < config.min_watch_calibration_ready_ratio
    ):
        return BLOCK_STATUS
    if (
        ...
        or evidence_reuse_ratio < config.min_pass_evidence_reuse_ratio
        or observation.calibration_sample_count < config.min_pass_calibration_sample_count
        or observation.calibration_ready_ratio < config.min_pass_calibration_ready_ratio
    ):
        return WATCH_STATUS
    return PASS_STATUS
...
def _row_reason_codes(
    *,
    ...
    if status == BLOCK_STATUS:
        ...
        if evidence_reuse_ratio < config.min_watch_evidence_reuse_ratio:
            reasons.append(EVIDENCE_REUSE_BELOW_WATCH_REASON)
        if observation.calibration_sample_count < config.min_watch_calibration_sample_count:
            reasons.append(CALIBRATION_SAMPLE_BELOW_WATCH_REASON)
        if observation.calibration_ready_ratio < config.min_watch_calibration_ready_ratio:
            reasons.append(CALIBRATION_READY_BELOW_WATCH_REASON)
    ...
    if evidence_reuse_ratio < config.min_pass_evidence_reuse_ratio:
        reasons.append(EVIDENCE_REUSE_BELOW_PASS_REASON)
    if observation.calibration_sample_count < config.min_pass_calibration_sample_count:
        reasons.append(CALIBRATION_SAMPLE_BELOW_PASS_REASON)
    if observation.calibration_ready_ratio < config.min_pass_calibration_ready_ratio:
        reasons.append(CALIBRATION_READY_BELOW_PASS_REASON)
    return _normalize_reason_codes(tuple(reasons), require_nonempty=True)


def _report_status(rows: tuple[ResearchEnergyEventTeamMemoryRow, ...]) -> str:
    if not rows:
        return BLOCK_STATUS
...
def _reason_code_counts(
    rows: tuple[ResearchEnergyEventTeamMemoryRow, ...],
) -> tuple[ResearchEnergyEventTeamMemoryReasonCodeCount, ...]:
    if not rows:
        return (
            ResearchEnergyEventTeamMemoryReasonCodeCount(
...
def _normalize_observations(
    ...
    *,
    ...
    for observation in observations:
        if type(observation) is not ResearchEnergyEventTeamMemoryObservation:
            raise ValueError(
                "observations must contain ResearchEnergyEventTeamMemoryObservation",
            )
...
def _validate_config(config: ResearchEnergyEventTeamMemoryConfig) -> None:
    ...
    if config.min_pass_evidence_reuse_ratio < config.min_watch_evidence_reuse_ratio:
        raise ValueError(
            "min_pass_evidence_reuse_ratio must be >= "
            "min_watch_evidence_reuse_ratio",
        )
    if (
        ...
        raise ValueError(
            "min_pass_calibration_sample_count must be >= "
            "min_watch_calibration_sample_count",
        )
    if config.min_pass_calibration_ready_ratio < config.min_watch_calibration_ready_ratio:
        raise ValueError(
            "min_pass_calibration_ready_ratio must be >= "
            "min_watch_calibration_ready_ratio",
        )


def _validate_observation(observation: ResearchEnergyEventTeamMemoryObservation) -> None:
    if (
    ...
    if observation.evidence_reuse_count > observation.source_count:
        raise ValueError("evidence_reuse_count must not exceed source_count")


def _validate_row(row: ResearchEnergyEventTeamMemoryRow) -> None:
    if row.fresh_source_count + row.stale_source_count != row.source_count:
        raise ValueError(
            "fresh and stale source counts must equal source_count",
        )
    if row.evidence_reuse_count > row.source_count:
        raise ValueError("evidence_reuse_count must not exceed source_count")
    ...
    if row.evidence_reuse_ratio != _ratio(row.evidence_reuse_count, row.source_count):
        raise ValueError("evidence_reuse_ratio must match source counts")
    if row.status != _status_from_reason_codes(row.reason_codes):
        raise ValueError("status must match reason_codes")


def _validate_report(report: ResearchEnergyEventTeamMemoryReport) -> None:
    rows = report.rows
    ...
    if report.evidence_reuse_count != _sum_rows(rows, "evidence_reuse_count"):
        raise ValueError("evidence_reuse_count must match rows")
    if report.calibration_sample_count != _sum_rows(rows, "calibration_sample_count"):
        raise ValueError("calibration_sample_count must match rows")
    ...
    if report.overall_evidence_reuse_ratio != _ratio(
        _sum_rows(rows, "evidence_reuse_count"),
        _sum_rows(rows, "source_count"),
    ):
        raise ValueError("overall_evidence_reuse_ratio must match rows")
    if report.average_calibration_ready_ratio != _average_row_ratio(
        rows,
        "calibration_ready_ratio",
    ):
        raise ValueError("average_calibration_ready_ratio must match rows")
    if report.min_calibration_sample_count != _min_row_decimal(
        rows,
        "calibration_sample_count",
    ):
...
def _row_sort_key(row: ResearchEnergyEventTeamMemoryRow) -> tuple[int, str, str]:
    return (
...
def _normalize_reason_code_counts(
    value: tuple[ResearchEnergyEventTeamMemoryReasonCodeCount, ...],
) -> tuple[ResearchEnergyEventTeamMemoryReasonCodeCount, ...]:
    if type(value) is not tuple:
        raise ValueError("reason_code_counts must be a tuple")
    for item in value:
        if type(item) is not ResearchEnergyEventTeamMemoryReasonCodeCount:
            raise ValueError(
...
def _normalize_rows(
    value: tuple[ResearchEnergyEventTeamMemoryRow, ...],
) -> tuple[ResearchEnergyEventTeamMemoryRow, ...]:
    if type(value) is not tuple:
        raise ValueError("rows must be a tuple")
    for row in value:
        if type(row) is not ResearchEnergyEventTeamMemoryRow:
            raise ValueError("rows must contain ResearchEnergyEventTeamMemoryRow")
