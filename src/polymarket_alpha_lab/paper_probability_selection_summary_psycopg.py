"""Optional psycopg adapter for paper probability selection summary persistence."""
...
def insert_paper_probability_selection_summary_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_paper_probability_selection_summary_report(
            connection,
            report,
...
def load_paper_probability_selection_summary_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_paper_probability_selection_summary_reports(
            connection,
