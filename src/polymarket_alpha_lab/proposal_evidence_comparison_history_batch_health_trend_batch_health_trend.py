...
class TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendConfig:
    ...
    def __post_init__(self) -> None:
        ...
        _require_nonnegative_int("min_trend_batch_health_report_count", self.min_trend_batch_health_report_count)
        _require_probability_decimal(
            "max_incomplete_trend_batch_health_ratio",
            self.max_incomplete_trend_batch_health_ratio,
        )
        _require_probability_decimal(
...
class TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendStatusRow:
    ...
    def __post_init__(self) -> None:
        if self.trend_batch_health_status not in TREND_BATCH_HEALTH_STATUSES:
            raise ValueError("trend_batch_health_status must be a known trend batch status")
        _require_nonnegative_int("trend_batch_health_count", self.trend_batch_health_count)
        _require_optional_probability_decimal("trend_batch_health_ratio", self.trend_batch_health_ratio)
...
class TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendConfigVersionSummary:
    ...
    def __post_init__(self) -> None:
        _require_canonical_string("trend_batch_health_config_version", self.trend_batch_health_config_version)
        _require_positive_int("trend_batch_health_count", self.trend_batch_health_count)
...
class TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(
            self,
            "first_trend_batch_health_generated_at",
            _as_optional_utc(self.first_trend_batch_health_generated_at),
        )
        object.__setattr__(
            self,
            "last_trend_batch_health_generated_at",
            _as_optional_utc(self.last_trend_batch_health_generated_at),
        )
        _require_canonical_string("config_version", self.config_version)
        ...
        _require_boundary_statement(self.boundary_statement)
        for field_name in (
            "trend_batch_health_report_count",
            "ready_trend_batch_health_report_count",
            "incomplete_trend_batch_health_report_count",
            "duplicate_generated_at_trend_batch_health_report_count",
            "duplicate_fingerprint_trend_batch_health_report_count",
            "duplicate_generated_at_count",
            "duplicate_fingerprint_count",
        ):
            _require_nonnegative_int(field_name, getattr(self, field_name))
        for field_name in (
            "incomplete_trend_batch_health_ratio",
        ...
        if self.status not in REPORT_STATUSES:
            raise ValueError("status must be a known trend batch health trend status")
        object.__setattr__(
            self,
            "gate_results",
            _clone_trend_batch_health_gate_results(self.gate_results),
        )
        ...
        _validate_trend_batch_health_trend_report_rows(self)
        if self.status != _trend_batch_health_trend_status(self.gate_results):
            raise ValueError("status must match trend batch health trend gate results")
...
class TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendLog:
    ...
    def append(
        ...
        if type(report) is not TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport:
            raise ValueError(
                "report must be a "
                "TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport"
            )
        validated = _validate_trend_batch_health_trend_report_tree(report)
...
def build_trade_proposal_evidence_comparison_history_batch_health_trend_batch_health_trend_report(
    ...
    *,
    ...
    if type(config) is not TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendConfig:
        raise ValueError(
            "config must be a "
            "TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendConfig"
        )
    ...
    reports = _normalize_trend_batch_health_report_inputs(trend_batch_health_reports)
    total = len(reports)
    ...
    gate_results = _build_gate_results(
        trend_batch_health_report_count=total,
    ...
    return TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport(
        generated_at=generated_at,
        config_version=config.config_version,
        report_only=True,
        boundary_statement=config.boundary_statement,
        trend_batch_health_report_count=total,
        ready_trend_batch_health_report_count=ready_count,
        incomplete_trend_batch_health_report_count=status_counts[
            "incomplete_batch_health_trend_batch_health"
        ],
        duplicate_generated_at_trend_batch_health_report_count=status_counts[
            "duplicate_generated_at_batch_health_trend_batch_health"
        ],
        duplicate_fingerprint_trend_batch_health_report_count=status_counts[
            "duplicate_fingerprint_batch_health_trend_batch_health"
        ],
        duplicate_generated_at_count=duplicate_generated_at_count,
        duplicate_fingerprint_count=duplicate_fingerprint_count,
        incomplete_trend_batch_health_ratio=incomplete_ratio,
        duplicate_generated_at_ratio=duplicate_generated_at_ratio,
        duplicate_fingerprint_ratio=duplicate_fingerprint_ratio,
        first_trend_batch_health_generated_at=reports[0].generated_at if reports else None,
        last_trend_batch_health_generated_at=reports[-1].generated_at if reports else None,
        status=_trend_batch_health_trend_status(gate_results),
...
def _normalize_trend_batch_health_report_inputs(
    trend_batch_health_reports: (
        list[TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthReport]
        | tuple[TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthReport, ...]
    ),
) -> tuple[TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthReport, ...]:
    if type(trend_batch_health_reports) not in (list, tuple):
        raise ValueError(
            "trend_batch_health_reports must be a list or tuple of trend batch health reports"
        )
    supplied = tuple(trend_batch_health_reports)
    cloned = tuple(_clone_trend_batch_health_report(item) for item in supplied)
    return tuple(
        sorted(
            cloned,
            key=lambda report: (
...
def _clone_trend_batch_health_report(
    ...
    if type(report) is not TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthReport:
        raise ValueError(
            "trend_batch_health_reports must contain "
            "TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthReport values"
        )
    gate_results = tuple(
        _clone_upstream_trend_batch_health_gate_result(row)
...
def _clone_upstream_trend_batch_health_gate_result(
    row: TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthGateResult,
) -> TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthGateResult:
    if row.gate_name == "trend_batch_sample" and row.status == "fail":
        raise ValueError("trend_batch_sample cannot fail")
...
def _build_status_counts(
    reports: tuple[TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthReport, ...],
) -> dict[str, int]:
    counts = {status: 0 for status in TREND_BATCH_HEALTH_STATUSES}
...
def _build_gate_results(
    *,
    ...
    duplicate_fingerprint_ratio: Decimal | None,
    config: TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendConfig,
) -> tuple[TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateResult, ...]:
    sample_passes = trend_batch_health_report_count >= config.min_trend_batch_health_report_count
    return (
        TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateResult(
            "trend_batch_health_sample",
            "pass" if sample_passes else "incomplete",
            (
                "Supplied trend batch health report sample meets the threshold."
                if sample_passes
                else "Supplied trend batch health report sample is below the threshold."
            ),
            trend_batch_health_report_count,
            config.min_trend_batch_health_report_count,
        ),
        _rate_gate(
            "incomplete_trend_batch_health_rate",
            incomplete_ratio,
            config.max_incomplete_trend_batch_health_ratio,
            "Incomplete trend batch health",
        ),
        _rate_gate(
            "duplicate_generated_at_rate",
            duplicate_generated_at_ratio,
...
def _rate_gate(
    ...
    if ratio is None:
        status = "incomplete"
        message = f"{label} rate is unavailable without trend batch health reports."
    ...
    return TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateResult(
        gate_name,
        status,
        message,
        ratio,
...
def _build_status_rows(
    ...
    total: int,
) -> tuple[TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendStatusRow, ...]:
    return tuple(
        TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendStatusRow(
            status,
        ...
        for status in TREND_BATCH_HEALTH_STATUSES
    )
...
def _duplicate_fingerprint_summaries(
    ...
    counts: dict[str, int] = {}
    for report in reports:
        fingerprint = _trend_batch_health_report_fingerprint(report)
...
def _trend_batch_health_report_fingerprint(
    report: TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthReport,
) -> str:
    return json.dumps(_json_ready(asdict(report)), allow_nan=False, sort_keys=True)


def _trend_batch_health_trend_status(
    gate_results: tuple[TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateResult, ...],
) -> str:
    gates = {row.gate_name: row.status for row in gate_results}
    if gates["trend_batch_health_sample"] == "incomplete":
        return "incomplete_batch_health_trend_batch_health_trend"
    if gates["duplicate_generated_at_rate"] == "fail":
        return "duplicate_generated_at_batch_health_trend_batch_health_trend"
    if gates["duplicate_fingerprint_rate"] == "fail":
        return "duplicate_fingerprint_batch_health_trend_batch_health_trend"
    if gates["incomplete_trend_batch_health_rate"] == "fail":
        return "incomplete_batch_health_trend_batch_health_trend"
    if any(status == "incomplete" for status in gates.values()):
        return "incomplete_batch_health_trend_batch_health_trend"
    return "proposal_evidence_comparison_history_batch_health_trend_batch_health_trend_ready"
...
def _validate_trend_batch_health_trend_report_tree(
    report: TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport,
) -> TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport:
    return TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport(
        ...
        report_only=report.report_only,
        boundary_statement=report.boundary_statement,
        trend_batch_health_report_count=report.trend_batch_health_report_count,
        ready_trend_batch_health_report_count=report.ready_trend_batch_health_report_count,
        incomplete_trend_batch_health_report_count=report.incomplete_trend_batch_health_report_count,
        duplicate_generated_at_trend_batch_health_report_count=(
            report.duplicate_generated_at_trend_batch_health_report_count
        ),
        duplicate_fingerprint_trend_batch_health_report_count=(
            report.duplicate_fingerprint_trend_batch_health_report_count
        ),
        duplicate_generated_at_count=report.duplicate_generated_at_count,
        duplicate_fingerprint_count=report.duplicate_fingerprint_count,
        incomplete_trend_batch_health_ratio=report.incomplete_trend_batch_health_ratio,
        duplicate_generated_at_ratio=report.duplicate_generated_at_ratio,
        duplicate_fingerprint_ratio=report.duplicate_fingerprint_ratio,
        first_trend_batch_health_generated_at=report.first_trend_batch_health_generated_at,
        last_trend_batch_health_generated_at=report.last_trend_batch_health_generated_at,
        status=report.status,
...
def _validate_trend_batch_health_trend_report_rows(
    report: TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendReport,
) -> None:
    if tuple(row.gate_name for row in report.gate_results) != GATE_NAMES:
        raise ValueError("gate_results must contain trend batch health trend gates")
    status_row_keys = tuple(row.trend_batch_health_status for row in report.status_rows)
    if status_row_keys != TREND_BATCH_HEALTH_STATUSES:
        raise ValueError("status_rows must contain sorted trend batch health statuses")
    status_counts = {row.trend_batch_health_status: row.trend_batch_health_count for row in report.status_rows}
    if status_counts[
        "proposal_evidence_comparison_history_batch_health_trend_batch_health_ready"
    ] != report.ready_trend_batch_health_report_count:
        raise ValueError("status_rows must match ready trend batch health count")
    if status_counts["incomplete_batch_health_trend_batch_health"] != (
        report.incomplete_trend_batch_health_report_count
    ):
        raise ValueError("status_rows must match incomplete trend batch health count")
    if status_counts["duplicate_generated_at_batch_health_trend_batch_health"] != (
        report.duplicate_generated_at_trend_batch_health_report_count
    ):
        raise ValueError("status_rows must match duplicate generated-at trend batch health count")
    if status_counts["duplicate_fingerprint_batch_health_trend_batch_health"] != (
        report.duplicate_fingerprint_trend_batch_health_report_count
    ):
        raise ValueError("status_rows must match duplicate fingerprint trend batch health count")
    if sum(status_counts.values()) != report.trend_batch_health_report_count:
        raise ValueError("status_rows must sum to trend_batch_health_report_count")
    expected_ratios = {
        status: _ratio(count, report.trend_batch_health_report_count)
        for status, count in status_counts.items()
    }
    for row in report.status_rows:
        if not _ratio_value_matches(
            row.trend_batch_health_ratio,
            expected_ratios[row.trend_batch_health_status],
        ):
            raise ValueError("status_rows must contain expected ratios")
    expected_incomplete = report.trend_batch_health_report_count - report.ready_trend_batch_health_report_count
    _validate_ratio_field(report, "incomplete_trend_batch_health_ratio", expected_incomplete)
...
def _validate_ratio_field(
    ...
    expected = _ratio(count, report.trend_batch_health_report_count)
...
def _validate_time_bounds(
    ...
    if report.trend_batch_health_report_count == 0:
        if (
            report.first_trend_batch_health_generated_at is not None
            or report.last_trend_batch_health_generated_at is not None
        ):
            raise ValueError("trend batch health time bounds must be empty without reports")
    else:
        if (
            report.first_trend_batch_health_generated_at is None
            or report.last_trend_batch_health_generated_at is None
        ):
            raise ValueError("trend batch health time bounds must be present with reports")
        if report.first_trend_batch_health_generated_at > report.last_trend_batch_health_generated_at:
            raise ValueError("trend batch health time bounds must be ordered")
...
def _validate_duplicate_summaries(
    ...
    for row in report.duplicate_generated_at_summaries:
        if (
            report.first_trend_batch_health_generated_at is None
            or report.last_trend_batch_health_generated_at is None
            or row.generated_at < report.first_trend_batch_health_generated_at
            or row.generated_at > report.last_trend_batch_health_generated_at
        ):
            raise ValueError("duplicate_generated_at_summaries must be within time bounds")
        if row.duplicate_count > report.trend_batch_health_report_count:
...
def _validate_config_version_summaries(
    ...
    versions = tuple(row.trend_batch_health_config_version for row in report.config_version_summaries)
    ...
    if sum(row.trend_batch_health_count for row in report.config_version_summaries) != (
...
def _validate_gate_status_summaries(
    ...
    for row in report.gate_status_summaries:
        if row.gate_name not in NODE_14_TREND_BATCH_HEALTH_GATE_NAMES:
            raise ValueError("gate_status_summaries must contain known trend batch health gates")
        if row.gate_status not in GATE_STATUSES:
            raise ValueError("gate_status_summaries must contain known gate statuses")
        if row.gate_name == "trend_batch_sample" and row.gate_status == "fail":
            raise ValueError("trend_batch_sample cannot fail")
        _require_positive_int(
            "gate_status_summaries trend_batch_health_count",
            row.trend_batch_health_count,
        )
    ...
    expected_gate_status_count = (
        len(NODE_14_TREND_BATCH_HEALTH_GATE_NAMES) * report.trend_batch_health_report_count
    )
    observed_gate_status_count = sum(
        row.trend_batch_health_count for row in report.gate_status_summaries
    )
    ...
    for gate_name in NODE_14_TREND_BATCH_HEALTH_GATE_NAMES:
        gate_count = sum(
            row.trend_batch_health_count
            for row in report.gate_status_summaries
            if row.gate_name == gate_name
        )
        if gate_count != report.trend_batch_health_report_count:
    ...
    for row in report.gate_status_summaries:
        ...
        if row.trend_batch_health_count > report.trend_batch_health_report_count:
...
def _validate_gate_payloads(
    ...
    sample_gate = gates["trend_batch_health_sample"]
    if type(sample_gate.observed_value) is not int:
        raise ValueError("gate_results trend_batch_health_sample observed_value must be an int")
    if sample_gate.observed_value != report.trend_batch_health_report_count:
        raise ValueError("gate_results must match trend_batch_health_report_count")
    if type(sample_gate.threshold) is not int:
        raise ValueError("gate_results trend_batch_health_sample threshold must be an int")
    _require_nonnegative_int(
        "gate_results trend_batch_health_sample threshold",
        sample_gate.threshold,
    )
    expected_sample_status = (
        "pass" if report.trend_batch_health_report_count >= sample_gate.threshold else "incomplete"
    )
    if sample_gate.status != expected_sample_status:
        raise ValueError("gate_results trend_batch_health_sample status must match threshold")
    _validate_rate_gate_payload(
        gates["incomplete_trend_batch_health_rate"],
        report.incomplete_trend_batch_health_ratio,
        "gate_results incomplete_trend_batch_health_rate",
    )
    _validate_rate_gate_payload(
...
def _validate_rate_gate_payload(
    gate: TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateResult,
    ratio: Decimal | None,
    field_name: str,
) -> None:
...
def _clone_trend_batch_health_gate_results(
    gate_results: tuple[
        TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateResult,
        ...,
    ],
...
def _clone_config_version_summaries(
    ...
    return tuple(
        TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendConfigVersionSummary(
            row.trend_batch_health_config_version,
            row.trend_batch_health_count,
        )
        for row in _normalize_typed_tuple(
            "config_version_summaries",
...
def _clone_gate_status_summaries(
    ...
    return tuple(
        _clone_gate_status_summary(row)
        for row in _normalize_typed_tuple(
            "gate_status_summaries",
            summaries,
            TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateStatusSummary,
...
def _clone_gate_status_summary(
    row: TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateStatusSummary,
) -> TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateStatusSummary:
    clone = object.__new__(
        TradeProposalEvidenceComparisonHistoryBatchHealthTrendBatchHealthTrendGateStatusSummary,
    )
    object.__setattr__(clone, "gate_name", row.gate_name)
    object.__setattr__(clone, "gate_status", row.gate_status)
    object.__setattr__(
        clone,
        "trend_batch_health_count",
        row.trend_batch_health_count,
    )
    return clone
...
def _require_boundary_statement(value: str) -> None:
    ...
    if (
        ...
        raise ValueError(
            ...
            "history batch health trend batch health trend"
        )
