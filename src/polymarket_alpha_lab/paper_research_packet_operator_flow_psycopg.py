"""Optional psycopg adapter for paper research packet operator flow storage."""
...
def insert_paper_research_packet_operator_flow_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_paper_research_packet_operator_flow_report(
            connection,
            report,
...
def load_paper_research_packet_operator_flow_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_paper_research_packet_operator_flow_reports(
            connection,
