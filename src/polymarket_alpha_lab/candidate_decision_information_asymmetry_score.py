"""Pure report-only public information asymmetry scoring."""
...
DEFAULT_CANDIDATE_DECISION_INFORMATION_ASYMMETRY_SCORE_CONFIG_VERSION = (
    "candidate-decision-information-asymmetry-score-v0"
)
...
INFORMATION_ASYMMETRY_STATUSES = ("pass", "watch", "block")

_BASE_REASON_CODE = "candidate_decision_information_asymmetry_score"
_INPUT_FIELDS = (
    "public_source_count",
    "specialist_edge_score",
    "crowd_attention_score",
    "information_dispersion_score",
    "stale_consensus_score",
    "source_quality_score",
)
_LEVEL_FIELDS = (
    *_INPUT_FIELDS,
    "public_information_priority_score",
)
_CONFIG_THRESHOLD_FIELDS = (
    "min_pass_public_source_count",
    "min_watch_public_source_count",
    "min_pass_specialist_edge_score",
    "min_watch_specialist_edge_score",
    "max_pass_crowd_attention_score",
    "max_watch_crowd_attention_score",
    "min_pass_information_dispersion_score",
    "min_watch_information_dispersion_score",
    "min_pass_stale_consensus_score",
    "min_watch_stale_consensus_score",
    "min_pass_source_quality_score",
    "min_watch_source_quality_score",
    "min_pass_public_information_priority_score",
    "min_watch_public_information_priority_score",
)
_CONFIG_WEIGHT_FIELDS = (
    "public_source_depth_weight",
    "specialist_edge_weight",
    "crowd_underattention_weight",
    "information_dispersion_weight",
    "stale_consensus_weight",
    "source_quality_weight",
)
_DERIVED_FIELDS = (
    "public_source_depth_score",
    "crowd_underattention_score",
    "public_information_priority_score",
)
...
class CandidateDecisionInformationAsymmetryScoreConfig:
    config_version: str = (
        DEFAULT_CANDIDATE_DECISION_INFORMATION_ASYMMETRY_SCORE_CONFIG_VERSION
    )
    min_pass_public_source_count: Decimal = Decimal("3.000000")
    min_watch_public_source_count: Decimal = Decimal("1.000000")
    min_pass_specialist_edge_score: Decimal = Decimal("0.650000")
    min_watch_specialist_edge_score: Decimal = Decimal("0.350000")
    max_pass_crowd_attention_score: Decimal = Decimal("0.450000")
    max_watch_crowd_attention_score: Decimal = Decimal("0.750000")
    min_pass_information_dispersion_score: Decimal = Decimal("0.650000")
    min_watch_information_dispersion_score: Decimal = Decimal("0.350000")
    min_pass_stale_consensus_score: Decimal = Decimal("0.500000")
    min_watch_stale_consensus_score: Decimal = Decimal("0.250000")
    min_pass_source_quality_score: Decimal = Decimal("0.700000")
    min_watch_source_quality_score: Decimal = Decimal("0.400000")
    min_pass_public_information_priority_score: Decimal = Decimal("0.650000")
    min_watch_public_information_priority_score: Decimal = Decimal("0.400000")
    public_source_depth_weight: Decimal = Decimal("0.200000")
    specialist_edge_weight: Decimal = Decimal("0.200000")
    crowd_underattention_weight: Decimal = Decimal("0.150000")
    information_dispersion_weight: Decimal = Decimal("0.150000")
    stale_consensus_weight: Decimal = Decimal("0.150000")
    ...
    def __post_init__(self) -> None:
        if type(self) is not CandidateDecisionInformationAsymmetryScoreConfig:
            raise ValueError(
                "config must be a CandidateDecisionInformationAsymmetryScoreConfig",
            )
...
@dataclass(frozen=True)
class CandidateDecisionInformationAsymmetryScoreInput:
    redacted_candidate_ref: str
    public_source_count: Decimal
    specialist_edge_score: Decimal
    crowd_attention_score: Decimal
    information_dispersion_score: Decimal
    stale_consensus_score: Decimal
    ...
    def __post_init__(self) -> None:
        if type(self) is not CandidateDecisionInformationAsymmetryScoreInput:
            raise ValueError(
                "input_value must be a CandidateDecisionInformationAsymmetryScoreInput",
            )
...
@dataclass(frozen=True)
class CandidateDecisionInformationAsymmetryScoreReport:
    config_version: str
    redacted_candidate_ref: str
    public_source_count: Decimal
    specialist_edge_score: Decimal
    ...
    stale_consensus_score: Decimal
    source_quality_score: Decimal
    public_source_depth_score: Decimal
    crowd_underattention_score: Decimal
    public_information_priority_score: Decimal
    status: str
    hard_flag_codes: tuple[str, ...]
    reason_codes: tuple[str, ...]
    min_pass_public_source_count: Decimal
    min_watch_public_source_count: Decimal
    min_pass_specialist_edge_score: Decimal
    min_watch_specialist_edge_score: Decimal
    max_pass_crowd_attention_score: Decimal
    max_watch_crowd_attention_score: Decimal
    min_pass_information_dispersion_score: Decimal
    min_watch_information_dispersion_score: Decimal
    min_pass_stale_consensus_score: Decimal
    min_watch_stale_consensus_score: Decimal
    min_pass_source_quality_score: Decimal
    min_watch_source_quality_score: Decimal
    min_pass_public_information_priority_score: Decimal
    min_watch_public_information_priority_score: Decimal
    public_source_depth_weight: Decimal
    specialist_edge_weight: Decimal
    crowd_underattention_weight: Decimal
    information_dispersion_weight: Decimal
    stale_consensus_weight: Decimal
    source_quality_weight: Decimal
    ...
    def __post_init__(self) -> None:
        if type(self) is not CandidateDecisionInformationAsymmetryScoreReport:
            raise ValueError(
                "report must be a CandidateDecisionInformationAsymmetryScoreReport",
            )
        _require_canonical_string("config_version", self.config_version)
        _require_canonical_string("redacted_candidate_ref", self.redacted_candidate_ref)
        _reject_unsafe_public_text("redacted_candidate_ref", self.redacted_candidate_ref)
        ...
        _require_member("status", self.status, INFORMATION_ASYMMETRY_STATUSES)
        object.__setattr__(
            self,
            "hard_flag_codes",
    ...
    def payload(self) -> dict[str, Any]:
        return candidate_decision_information_asymmetry_score_payload(self)


def score_candidate_decision_information_asymmetry(
    input_value: CandidateDecisionInformationAsymmetryScoreInput,
    *,
    config: CandidateDecisionInformationAsymmetryScoreConfig,
) -> CandidateDecisionInformationAsymmetryScoreReport:
    if type(input_value) is not CandidateDecisionInformationAsymmetryScoreInput:
        raise ValueError(
            "input_value must be a CandidateDecisionInformationAsymmetryScoreInput",
        )
    if type(config) is not CandidateDecisionInformationAsymmetryScoreConfig:
        raise ValueError(
            "config must be a CandidateDecisionInformationAsymmetryScoreConfig",
        )
    ...
    report_values: dict[str, object] = {
        ...
        "specialist_edge_score": input_value.specialist_edge_score,
        "crowd_attention_score": input_value.crowd_attention_score,
        "information_dispersion_score": input_value.information_dispersion_score,
        "stale_consensus_score": input_value.stale_consensus_score,
        "source_quality_score": input_value.source_quality_score,
        "public_source_depth_score": metrics["public_source_depth_score"],
        "crowd_underattention_score": metrics["crowd_underattention_score"],
        "public_information_priority_score": metrics[
            "public_information_priority_score"
        ],
        "status": status,
    ...
    return CandidateDecisionInformationAsymmetryScoreReport(
        **report_values,
        derived_validation_digest=_digest_from_values(report_values),
    )


def candidate_decision_information_asymmetry_score_payload(
    report: CandidateDecisionInformationAsymmetryScoreReport,
) -> dict[str, Any]:
    if type(report) is not CandidateDecisionInformationAsymmetryScoreReport:
        raise ValueError(
            "report must be a CandidateDecisionInformationAsymmetryScoreReport",
        )
    ...
    validate_candidate_decision_information_asymmetry_score_public_payload(payload)
    return payload


def validate_candidate_decision_information_asymmetry_score_public_payload(
...
def _score_metrics(
    ...
    public_source_depth_score = _normalize_unit_decimal(
        "public_source_depth_score",
        min(ONE, input_value.public_source_count / config.min_pass_public_source_count),
    )
    crowd_underattention_score = _normalize_unit_decimal(
        "crowd_underattention_score",
        ONE - input_value.crowd_attention_score,
    )
    public_information_priority_score = _normalize_unit_decimal(
        "public_information_priority_score",
        public_source_depth_score * config.public_source_depth_weight
        + input_value.specialist_edge_score * config.specialist_edge_weight
        + crowd_underattention_score * config.crowd_underattention_weight
        + input_value.information_dispersion_score * config.information_dispersion_weight
        + input_value.stale_consensus_score * config.stale_consensus_weight
        + input_value.source_quality_score * config.source_quality_weight,
    )
    return {
        "public_source_depth_score": public_source_depth_score,
        "crowd_underattention_score": crowd_underattention_score,
        "public_information_priority_score": public_information_priority_score,
    }
...
def _status_levels(
    ...
    return {
        ...
        "specialist_edge_score": _min_threshold_level(
            input_value.specialist_edge_score,
            config.min_pass_specialist_edge_score,
            config.min_watch_specialist_edge_score,
        ),
        ...
        "information_dispersion_score": _min_threshold_level(
            input_value.information_dispersion_score,
            config.min_pass_information_dispersion_score,
            config.min_watch_information_dispersion_score,
        ),
        "stale_consensus_score": _min_threshold_level(
            input_value.stale_consensus_score,
            config.min_pass_stale_consensus_score,
            config.min_watch_stale_consensus_score,
        ),
        ...
        "public_information_priority_score": _min_threshold_level(
            metrics["public_information_priority_score"],
            config.min_pass_public_information_priority_score,
            config.min_watch_public_information_priority_score,
        ),
    }
...
def _validate_report_consistency(
    ...
    input_value = CandidateDecisionInformationAsymmetryScoreInput(
        ...
        specialist_edge_score=report.specialist_edge_score,
        crowd_attention_score=report.crowd_attention_score,
        information_dispersion_score=report.information_dispersion_score,
        stale_consensus_score=report.stale_consensus_score,
...
def _validate_config_thresholds(
    ...
    if (
        ...
        raise ValueError(
            "min_watch_specialist_edge_score must not exceed pass threshold",
        )
    ...
    if (
        ...
        raise ValueError(
            "min_watch_information_dispersion_score must not exceed pass threshold",
        )
    if config.min_watch_stale_consensus_score > config.min_pass_stale_consensus_score:
        raise ValueError(
            "min_watch_stale_consensus_score must not exceed pass threshold",
        )
    ...
    if (
        ...
        raise ValueError(
            "min_watch_public_information_priority_score must not exceed pass threshold",
        )
...
def _require_public_payload_flags(payload: dict[str, Any]) -> None:
    ...
    if payload.get("status") not in INFORMATION_ASYMMETRY_STATUSES:
