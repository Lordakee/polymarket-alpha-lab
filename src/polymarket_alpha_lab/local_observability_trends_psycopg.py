"""Optional psycopg adapter for local observability trends reports."""
...
def insert_local_observability_trends_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_local_observability_trends_report(
            connection,
            report,
...
def load_local_observability_trends_reports_with_psycopg(
    dsn: str,
    *,
    limit: int | None = None,
    table_name: str = DEFAULT_LOCAL_OBSERVABILITY_TRENDS_TABLE,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_local_observability_trends_reports(
            connection,
            limit=limit,
            table_name=table_name,
        ),
