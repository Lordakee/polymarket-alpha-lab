"""Optional psycopg adapter for action-gated strategy recommendation queues."""
...
def insert_paper_action_gated_strategy_recommendation_queue_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_paper_action_gated_strategy_recommendation_queue_report(
            connection,
            report,
