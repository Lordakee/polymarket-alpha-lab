"""Optional psycopg adapter for paper recommendation reason trend storage."""
...
from polymarket_alpha_lab.paper_recommendation_reason_trend_store import (
    insert_paper_recommendation_reason_trend_report,
    load_paper_recommendation_reason_trend_reports,
)


DEFAULT_PAPER_RECOMMENDATION_REASON_TREND_TABLE = (
    "paper_recommendation_reason_trend_reports"
)
_T = TypeVar("_T")


def insert_paper_recommendation_reason_trend_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    table_name: str = DEFAULT_PAPER_RECOMMENDATION_REASON_TREND_TABLE,
) -> None:
    _with_owned_connection(
        dsn,
        lambda connection: insert_paper_recommendation_reason_trend_report(
            connection,
            report,
...
def load_paper_recommendation_reason_trend_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_paper_recommendation_reason_trend_reports(
            connection,
...
def _with_owned_connection(dsn: str, operation: Callable[[Any], _T]) -> _T:
    validate_local_postgres_dsn(
        dsn,
        env_var_name=PAPER_RECOMMENDATION_REASON_TREND_DB_DSN_ENV_VAR,
    )
...
def _connect(dsn: str) -> Any:
    ...
    try:
        ...
        raise RuntimeError(
            "failed to connect to the paper recommendation reason trend database",
        ) from exc
...
__all__ = (
    ...
    "load_paper_recommendation_reason_trend_reports_with_psycopg",
)
