"""Optional psycopg adapter for action-gated queue decision-support reports."""
...
def insert_paper_action_gated_strategy_recommendation_queue_decision_support_report_with_psycopg(
    dsn: str,
    priority_report: Any,
    risk_report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_paper_action_gated_strategy_recommendation_queue_decision_support_report(
            connection,
            priority_report,
            risk_report,
...
def load_paper_action_gated_strategy_recommendation_queue_decision_support_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_paper_action_gated_strategy_recommendation_queue_decision_support_reports(
            connection,
...
def _connect(dsn: str) -> Any:
    ...
    try:
        ...
        raise RuntimeError(
            "failed to connect to the action-gated queue decision-support database",
        ) from None
