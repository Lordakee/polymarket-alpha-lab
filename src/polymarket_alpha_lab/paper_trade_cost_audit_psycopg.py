"""Optional psycopg adapter for paper trade cost audit report storage."""
...
from polymarket_alpha_lab.paper_trade_cost_audit_store import (
...
def insert_paper_trade_cost_audit_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_paper_trade_cost_audit_report(
            connection,
            report,
...
def load_paper_trade_cost_audit_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_paper_trade_cost_audit_reports(
            connection,
...
def _connect(dsn: str) -> Any:
    try:
        ...
        if exc.name != "psycopg":
            raise
        raise RuntimeError(
            "psycopg is required to use the paper trade cost audit psycopg "
...
__all__ = (
    ...
    "load_paper_trade_cost_audit_reports_with_psycopg",
)
