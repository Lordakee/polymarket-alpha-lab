...
PUBLIC_ENTRYPOINTS = ('docs/research-model-budget.md', 'docs/research-dispatch.md', 'scripts/inspect_project_resolution.py', 'docs/research-resolution-inspection.md',
