...
PUBLIC_ENTRYPOINTS = ('docs/research-paper.md', 'scripts/manage_research_tasks.py', 'docs/research-model-budget.md', 'docs/research-dispatch.md', 'scripts/inspect_project_resolution.py', 'docs/research-resolution-inspection.md',
