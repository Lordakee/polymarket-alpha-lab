"""Optional psycopg adapter for paper autonomous readiness digest storage."""
...
def insert_paper_autonomous_readiness_digest_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_write_connection(
        dsn,
        lambda connection: insert_paper_autonomous_readiness_digest_report_with_result(
            connection,
            report,
...
def load_paper_autonomous_readiness_digest_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_read_connection(
        dsn,
        lambda connection: load_paper_autonomous_readiness_digest_reports(
            connection,
...
def _connect(dsn: str, *, autocommit: bool = False) -> Any:
    ...
    try:
        ...
        raise RuntimeError(
            "failed to connect to the paper autonomous readiness digest database",
        ) from None
