"""Optional psycopg adapter for paper trade attribution report storage."""
...
from polymarket_alpha_lab.paper_trade_attribution_store import (
...
from polymarket_alpha_lab.supabase_paper_trade_attribution_config import (
...
def insert_paper_trade_attribution_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_paper_trade_attribution_report(
            connection,
            report,
...
def load_paper_trade_attribution_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_paper_trade_attribution_reports(
            connection,
...
def _connect(dsn: str) -> Any:
    try:
        ...
        if exc.name != "psycopg":
            raise
        raise RuntimeError(
            "psycopg is required to use the paper trade attribution psycopg "
    ...
    try:
        ...
        raise RuntimeError(
            "failed to connect to the paper trade attribution database",
        ) from None
...
__all__ = (
    "insert_paper_trade_attribution_report_with_psycopg",
    "load_paper_trade_attribution_reports_with_psycopg",
)
