"""Optional psycopg adapter for autonomous market scorer persistence."""
...
def insert_autonomous_market_scorer_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_autonomous_market_scorer_report_with_result(
            connection,
            report,
...
def load_autonomous_market_scorer_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_autonomous_market_scorer_reports(
            connection,
