"""Optional psycopg adapter for paper project screening rank stability storage."""
...
def insert_paper_project_screening_rank_stability_report_with_psycopg(
    dsn: str,
    report: Any,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: insert_paper_project_screening_rank_stability_report(
            connection,
            report,
...
def load_paper_project_screening_rank_stability_reports_with_psycopg(
    dsn: str,
    *,
    ...
    return _with_owned_connection(
        dsn,
        lambda connection: load_paper_project_screening_rank_stability_reports(
            connection,
...
def _connect(dsn: str) -> Any:
    try:
        ...
        if exc.name != "psycopg":
            raise
        raise RuntimeError(
            "psycopg is required to use the paper project screening rank "
    ...
    try:
        ...
        raise RuntimeError(
            "failed to connect to the paper project screening rank stability database",
        ) from None
